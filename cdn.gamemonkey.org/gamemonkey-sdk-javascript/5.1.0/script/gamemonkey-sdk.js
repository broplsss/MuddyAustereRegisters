...
var GameMonkeySdk = /*#__PURE__*/function () {
  ...
  function GameMonkeySdk(orgId, domainId) {
    ...
    this.tracking = new _tracking.Tracking([new _dataSending.DataSending(GcpEnv[this.environment] + this.orgId + '/'), new _dataSending.DataSending(AwsEnv[this.environment] + this.orgId + '/')], this.visitor, this.domainId);
  }
